...
#ifndef NFD_DAEMON_FW_FUZZY_STRATEGY_HPP
#define NFD_DAEMON_FW_FUZZY_STRATEGY_HPP
 ...
 */
class FuzzyStrategy : public Strategy
                         , public ProcessNackTraits<FuzzyStrategy>
{
public:
  explicit
  FuzzyStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  friend ProcessNackTraits<FuzzyStrategy>;
};

} // namespace fw
} // namespace nfd

#endif // NFD_DAEMON_FW_FUZZY_STRATEGY_HPP
